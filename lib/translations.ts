...
export const t = {
  en: {
    ...
    pieceJourney: 'Piece Journey (quantity through stages)',
    expected: 'Expected',
    missing: 'Missing',
    missingItemsReport: 'Missing Items Report',
    lossPct: 'Loss %',
    ordersWithLoss: 'Orders with Missing Items',
    lossByStage: 'Loss by Stage',
    lostAt: 'Lost at',
    pcs: 'pcs',
    lossByStageHint: 'Where in the process pieces disappeared (total across all orders).',
    lossByManufacturer: 'Loss by Manufacturer',
    generated: 'Generated',
    ...
    estimateFromSale: 'from linked sale',
    ...
    printPdf: 'Print PDF',
    manufacturerAccount: 'Manufacturer Account',
    ...
    totalStockValue: 'Total Stock Value (EGP)',
    ...
    logisticCost: 'Logistic Cost (EGP)',
    logistics: 'Logistics',
    costBreakdown: 'Cost Breakdown',
    byStage: 'Production Cost by Stage',
    byCategory: 'All Expenses by Category',
    percentOfTotal: '% of Total',
    logisticsReport: 'Logistics Costs',
    orderLogistics: 'Order Logistics',
    source: 'Source',
    materialLogistics: 'Material Logistics',
    ...
    noTables: 'No cutting tables yet — add one to start planning.',
  ...
  ar: {
    ...
    orders: 'الطلبات',
    newOrder: 'طلب جديد',
    downloadAllPdf: 'تحميل كل الـ PDF',
    myOrders: 'طلباتي',
    materials: 'المواد',
    stock: 'المخزون',
    users: 'المستخدمون',
    ...
    due: 'موعد التسليم',
    daysLabel: 'يوم',
    overdueOrders: 'أوردرات متأخرة',
    dueSoonOrders: 'قريبة الاستحقاق',
    viewOverdue: 'عرض',
    ...
    quantitySubmitted: 'الكمية المُسلّمة',
    pieceJourney: 'رحلة القطع (الكمية عبر المراحل)',
    expected: 'المتوقع',
    missing: 'مفقود',
    missingItemsReport: 'تقرير القطع المفقودة',
    lossPct: 'نسبة الفقد',
    ordersWithLoss: 'الأوردرات ذات الفاقد',
    lossByStage: 'الفاقد حسب المرحلة',
    lostAt: 'فُقد في',
    pcs: 'قطعة',
    lossByStageHint: 'أين اختفت القطع خلال المراحل (الإجمالي لكل الأوردرات).',
    lossByManufacturer: 'الفاقد حسب المصنّع',
    ...
    profitEstimate: 'الربح التقديري',
    estimateFromSale: 'من عملية بيع مرتبطة',
    ...
    materialsSupplied: 'الخامات الموردة',
    total: 'الإجمالي',
    ...
    printPdf: 'طباعة PDF',
    manufacturerAccount: 'حساب المصنّع',
    ...
    materialsReport: 'تقرير الخامات',
    downloadExcel: 'تحميل Excel',
    totalPurchasedValue: 'إجمالي قيمة المشتريات',
    currentStockValue: 'قيمة المخزون الحالي',
    consumedValue: 'قيمة المستهلك',
    purchasedQty: 'الكمية المشتراة',
    purchasedValue: 'قيمة المشتريات',
    currentQty: 'الكمية الحالية',
    materialsBreakdown: 'تفصيل الخامات',
    purchasesByVendor: 'المشتريات حسب المورد',
    vendor: 'المورد',
    materialCode: 'الكود',
    unit: 'الوحدة',
    ...
    totalStockValue: 'إجمالي قيمة المخزون (ج.م)',
    ...
    adjust: 'تعديل',
    actualCount: 'الكمية الفعلية',
    logisticCost: 'تكلفة النقل (ج.م)',
    logistics: 'النقل',
    costBreakdown: 'توزيع التكاليف',
    byStage: 'تكلفة الإنتاج حسب المرحلة',
    byCategory: 'كل المصروفات حسب الفئة',
    percentOfTotal: '٪ من الإجمالي',
    logisticsReport: 'تكاليف النقل',
    orderLogistics: 'نقل الطلبات',
    source: 'المصدر',
    materialLogistics: 'نقل المواد',
    totalLogistics: 'إجمالي النقل',
    purchaseHistory: 'سجل المشتريات',
    usageHistory: 'سجل الاستخدام',
    vendorLabel: 'المورد',
    costLabel: 'التكلفة (ج.م)',
    orderLabel: 'الطلب',
    ...
    buyMore: 'شراء كمية',
    uploadReceipt: 'رفع الإيصال (صورة أو PDF)',
    ...
    noTables: 'لا توجد طاولات قص بعد — أضف طاولة لبدء التخطيط.',
